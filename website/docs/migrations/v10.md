...
reference docs. v10 keeps that foundation and adds the missing content-creation
path: generate or import assets, store provider credentials outside the project,
and hand local model files into Unity from tools such as Blender.
...
v10 is organized around four concrete changes:
