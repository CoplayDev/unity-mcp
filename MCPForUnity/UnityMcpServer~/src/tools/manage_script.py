...
def get_sha(
    ...
    Returns:
        dict: On success, returns {"success": True, "data": {"sha256": <str|null>, "lengthBytes": <int|null>}}.
        On failure, returns either the backend response dict or {"success": False, "message": <error string>}.
    """
