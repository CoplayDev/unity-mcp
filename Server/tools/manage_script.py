...
def get_sha(
    ...
    Returns:
        dict: On success, {"success": True, "data": {"sha256": <hex-string-or-none>, "lengthBytes": <int-or-none>}}.
              On failure, either the original response dict from Unity or {"success": False, "message": <error-string>}.
    """
